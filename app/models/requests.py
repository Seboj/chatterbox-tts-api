...
class TTSRequest(BaseModel):
    ...
    speed: Optional[float] = Field(1.0, description="Speed of speech (multiplier 0.5-2.0; honored on /audio/speech and /audio/speech/upload; no-op on streaming endpoints)")
